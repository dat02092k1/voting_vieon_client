        ...
        <div className="max-w-full pr-2">
          <div className="pb-3 lg:pb-0 px-[1.5px]">
            {rappers.map((rapper, index) => (
              ...
              <>
              {/* <Modal rapper={rapper} index={index} /> */}
              {/* <RapperItem key={rapper?._id} rapper={rapper} index={index} onClick={() => handleRapperClick(rapper)}  /> */}
            ...
            <div className="flex-auto">
              <div className="flex items-end justify-between w-full mb-1">
                ...
                <div className="flex lg:flex-row lg:justify-end items-center text-[10px] lg:text-[15px] text-white font-bold" onClick={() => handleVote(rapper)}>
