  ...
  return (
    <div className="max-w-xl mx-auto w-[94%] lg:w-[540px] bg-[#000] border-[2px] border-[#0ee2ff] relative z-20 p-4 lg:p-7">
      ...
      <div className="text-white text-center text-sm lg:text-[18px] lg:text-28 mb-[12px] lg:mb-[24px] flex items-end justify-center gap-3">
        ...
        <button onClick={handleCloseModal} className="text-white bg-center bg-no-repeat h-[40px]  lg:h-[60px] lg:w-[148px] uppercase font-bold text-[14px] lg:text-[22px] enabled:transition enabled:hover:bg-[#0acde7] border-2 border-[#0ee2ff] rounded">
          Không
        </button>
      </div>
